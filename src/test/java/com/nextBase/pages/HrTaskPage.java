...
public class HrTaskPage extends LoginPage {
    ...
    @FindBy(xpath = " (//a[contains(text(),'Time Editing Task')])[1]")
    public WebElement timeEditingTaskButton;
    @FindBy(xpath = "//a[@class='task-view-button edit ui-btn ui-btn-link']")
    public WebElement timeEditing;
    @FindBy(xpath = "//button[@data-bx-id='task-edit-submit']")
    public WebElement saveChangesButton;
    @FindBy(xpath = "(//div[@class='task-detail-sidebar-item-value'])[7]")
    public WebElement timeAssert;
